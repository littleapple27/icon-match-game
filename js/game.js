	...
	*/
	function startGame(){
		...
		for(i=0;i<value;i++){
			...
			card1='<div class="col-3 mb-2"><div class="p-2 border" data-card=""><i class="fas ' + deck1[i]+'" style="font-size: 1.5rem;"/></i></div></div>';
			card2='<div class="col-sm-6 col-xs-4 mb-2 "><div class="border py-1 w-100" style="font-size: .85rem;">' +deck2[i] +'</div></div>';
